...
print (findBattery(img2, method, myTuple))
cv2.waitKey(0)
print (findCircuitboard(img2, method, myTuple))
cv2.waitKey(0)
print (findMotor(img2, method, myTuple))
cv2.waitKey(0)
print (findSounddriver(img2, method, myTuple))
cv2.waitKey(0)
